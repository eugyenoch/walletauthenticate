...
$fnameErr = $lnameErr = $emailErr = $passErr = $cpassErr = $cpassesErr = $checkErr = $phoneErr = ""; 
...
if(isset($_POST['addUser'])){
  ...
  $sql_insert_user = "INSERT INTO users(firstname,lastname,user_email,user_pass,phone) VALUES('$fname','$lname','$email','$pass','$phone')";

  if($con->query($sql_insert_user) === TRUE){
    $toast = "success";
    header('Refresh:2,url=view-users.php');}
  else{$toast = "fail";}
...
<div class="container">
	<div class="row">
		<div class="col-md-6 m-auto col-xs-12">
                  ...
                  <div class="card-body">
                  		<h4 class="text-primary" style="color:steelblue !important;">Add a new user</h4>
      ...
      <div class="form-group has-feedback">
        <input type="tel" name="phone" class="form-control sty1" placeholder="Phone number">
      ...
      <div class="form-group has-feedback">
        <input type="password" name="pwd" class="form-control sty1" placeholder="Password" title="choose secure password" required>
      <span class="note"><small>Choose secure password for this user</small></span>
      ...
      <div>
        ...
        <!-- /.col -->
          <button type="submit" class="btn btn-success btn-block btn-flat" name="addUser"><i class="ti-angle-double-right"></i>&nbsp;Add User</button>
        </div>
        <!-- /.col --> 
      </div> 
    </form>
...
<script type="text/javascript">
  toastr.info('Use this section to add a new user','Info');
</script>
    </body>
    </html>
    <?php
if(isset($toast) && $toast==='success'){echo "<script>toastr.success('You have added a new user, he may login to edit his details', 'Success')</script>";}
