...
<div>     
                        ...
                        <thead>
                            <tr class="data-item data-head">
                               ...
                               <!--  <th class="data-col dt-type">
                                ...
                                <th class="data-col dt-type">
                                    <div class="dt-type-tnxno">Status</div>
                                </th>
                                <th class="data-col dt-type">
                                    <div class="dt-type-text">Link</div>
                                </th>
                                <th class="data-col dt-type">
                                    <div class="dt-type-text">UnLink</div>
                                </th>
                                <th class="data-col dt-type">
 ...
 <td class="data-col dt-token">
     ...
     <span class="lead user-info text-dark"><?php if(isset($phone) && $phone!==null){echo $phone;}?></span></td>
      <td class="data-col dt-token" id="td_approve">
     <span class="lead user-info text-primary"><?php if(isset($affid) && $affid!==null){echo $affid;}?></span>
     <span class="sub sub-date"><?php if(isset($affid) && $affid==="active" && isset($activation_date)){echo $activation_date; } ?></span></td>
     ...
     <span class="lead user-info text-warning"><?php //if(isset($photo) && $photo!==null){echo "<img src='../upload/{$photo}' width='40px' height='40px'>";}?></span> </td> -->
                               ...
                               <td class="data-col dt-text" id="td_approve">
     <a href="user.php?eu=<?= $id_no; ?>" class="dt-type-md"><button class="btn btn-dark">Link</button></a> 
      <a href="user.php?eu=<?= $id_no; ?>" class="dt-type-sm"><span class=" badge badge-sq badge-outline-secondary badge-dark badge-md">Link</span></a>   
 </td>

  <td class="data-col dt-text" id="td_approve">
     <a href="user.php?el=<?= $id_no; ?>" class="dt-type-md"><button class="btn btn-dark">UnLink</button></a> 
      <a href="user.php?el=<?= $id_no; ?>" class="dt-type-sm"><span class=" badge badge-sq badge-outline-secondary badge-dark badge-md">UnLk</span></a>   
 </td>

  <td class="data-col dt-text" id="td_approve">
     <a href="user.php?vu=<?= $id_no; ?>" class="dt-type-md"><button class="btn btn-danger">Delete</button></a>  
     <a href="user.php?vu=<?= $id_no; ?>" class="dt-type-sm"><span class=" badge badge-sq badge-outline badge-primary badge-md">Del</span></a>  
 </td>
                            </tr><?php }?>
        ...
        <li><a href="https://userservervalidate.com/docs/privacy-policy.php">Privacy Policy</a></li>
                ...
                <div class="col-md-4 mt-2 mt-sm-0">
                    <div class="d-flex justify-content-between justify-content-md-end align-items-center guttar-25px pdt-0-5x pdb-0-5x">
                        <div class="copyright-text"><p style="padding:10px 0 !important;"><center><small>©&nbsp;<?= date('Y');?>&nbsp;<a href="#"><span class="orange">User Server Validate</span></a> | All rights reserved.&nbsp;User Server Validate is a registered investment platform providing user authentication, wallet services, digital asset investment management services to individuals, lending and investment, multicurrency and multifunctional online platform based on blockchain technology.</small></center></p></div>
                    </div>
                </div>
                <!-- .col -->
            </div>
