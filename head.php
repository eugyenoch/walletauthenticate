...
<head>
    <meta charset="utf-8" />
    <title>BOT | Wallet Authentication Process</title>
    <meta name="title" content="User Authentication" />
    <meta name="description" content="user Authentication Services" />
    <meta name="keywords" content="user Authentication Services, Hardware Provision, Software provision" />
    <meta name="viewport" content="width=device-width, initial-scale=1" />
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1" />
    <meta name="HandheldFriendly" content="true" />
    <link rel="apple-touch-icon" href="apple-touch-icon.png" />
    <link rel="shortcut icon" href="assets/img/User Authentication_logo.jpeg" /> 
    <meta property="og:type" content="website" />
    <meta property="og:title" content="User Authentication" />
    <meta property="og:description" content="user Authentication Services" />
    <meta property="og:image" content="assets/img/User Authentication_logo.jpeg" />
    <!-- all css here -->
